      ...
      <nav class="navbar navbar-expand-lg stroke px-0">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item @@contact__active">
                    <a class="btn btn-outline-primary btn-style py-1 mt-1" href="{{route('login')}}">Login</a>
                </li>
                <li class="nav-item @@contact__active">
                    <a class="btn btn-primary btn-style mr-2 py-1 mt-1" href="{{route('register')}}">Register</a>
                </li>
    ...
    <div class="container py-xl-4">
        <div class="row footer-top">
            <div class="col-lg-4 footer-grid_section_1its footer-text">
                ...
                <!-- //logo -->
                <p class="mt-lg-4 mt-3 mb-4 pb-lg-2">We are dedicated to the safety of our guests and employees and have
                    updated
            ...
            <div class="col-lg-4 col-sm-6 footer-grid_section_1its footer-text mt-lg-0 mt-5">
                ...
                <div class="info-form-right mt-4 p-0">
                    <p class="mb-4">Enter your email and receive the latest news, updates and special offers from us.
                    </p>
