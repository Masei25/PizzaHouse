...
@section('content')
    ...
    <div class="container">
        <div class="mx-4 my-10">
            ...
            <p class="text-lg font-medium">Item Lists</p>
                                ...
                                <tr
                                    ...
                                    <td
                                        ...
                                        <span
                                            ...
                                            At</span>
                                        <span
                                            class="flex justify-end text-left lg:block">{{ $item->created_at->format('d-m-Y - h:i:s') }}</span>
                                    </td>
                                    <td
                                        class="relative block w-full p-3 text-center text-gray-800 border border-b lg:w-auto lg:table-cell lg:static">
                                        <span
                                        ...
                                        <span class="flex justify-center space-x-3 text-left">
                                            <a href="{{ route('edit.item', $item->slug) }}">
                                            ...
                                            <a href="{{ route('item.delete', $item->slug) }}"
                                                onclick="return confirm('are you sure you want to delete this item?')">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="text-red-700" viewBox="0 0 16 16">
                                                    <path
